        ...
        <div class="flex min-h-screen flex-col lg:flex-row">
            ...
            <div class="relative hidden flex-col justify-between overflow-hidden bg-brand-navy p-12 lg:flex lg:w-1/2 xl:p-16">
                ...
                <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                    <div class="relative size-[420px]">
                        ...
                        <div class="absolute top-1/2 left-1/2 flex size-28 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-3xl border border-brand-snow/10 bg-brand-navy-light">
                            <flux:icon.cube class="size-9 text-brand-accent" />
                        </div>
                    </div>
                </div>
                ...
                <a href="{{ route('home') }}" class="relative z-10 flex items-center gap-3" wire:navigate>
                    ...
                    <span class="flex flex-col leading-none">
                        ...
                        <span class="mt-1 font-mono text-[10px] tracking-[0.25em] text-brand-silver/80 uppercase">ERP Starter Kit</span>
                    </span>
                </a>
                ...
                <div class="relative z-10 max-w-md">
                    <h1 class="mb-6 font-display text-4xl leading-[1.1] font-bold tracking-tight text-brand-snow xl:text-5xl">
                        Stock, purchasing<br>
                        <span class="text-brand-accent">and sales</span><br>
                        in one ledger.
                    </h1>
                    ...
                    <ul class="grid grid-cols-3 gap-6 border-t border-brand-snow/10 pt-8">
                        <li>
                            <flux:icon.archive-box class="size-6 text-brand-accent" />
                            <div class="mt-2 text-[11px] tracking-wider text-brand-silver/80 uppercase">Inventory</div>
                        </li>
                        <li>
                            <flux:icon.truck class="size-6 text-brand-accent" />
                            <div class="mt-2 text-[11px] tracking-wider text-brand-silver/80 uppercase">Purchasing</div>
                        </li>
                        <li>
                            <flux:icon.shopping-cart class="size-6 text-brand-accent" />
                            <div class="mt-2 text-[11px] tracking-wider text-brand-silver/80 uppercase">Sales</div>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="relative flex flex-1 flex-col justify-center bg-brand-snow px-6 py-12 sm:px-12 lg:px-16 xl:px-24">
                <a href="{{ route('home') }}" class="absolute top-8 left-6 flex items-center gap-3 sm:left-12 lg:hidden" wire:navigate>
                    ...
                    <span class="flex flex-col leading-none">
                        <span class="font-display font-bold text-brand-navy">{{ config('app.name') }}</span>
                        <span class="mt-1 font-mono text-[9px] tracking-[0.25em] text-brand-navy/70 uppercase">ERP Starter Kit</span>
                    </span>
                </a>
